        ...
        <form method="POST" action="registro.php">
            <div id="regisContainer">
                ...
                <div>
                    ...
                    <p id="parrafoError"><?php if (isset($_GET['error_email'])) {
                ...
                <div>
                    ...
                    <p id="parrafoError"><?php if (isset($_GET['error_pass'])) {
                ...
                <div>
                    ...
                    <p id="parrafoError"><?php if (isset($_GET['error_pass_conf'])) {
                                                echo $_GET['error_pass_conf'];
                                            } ?></p>
                </div>
                <div>
                    <p id="parrafoError"><?php if (isset($_GET['error'])) {
                                                echo $_GET['error'];
                                            } ?></p>
